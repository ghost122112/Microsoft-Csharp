...
namespace Inheritance
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            InheritanceSourceCode sourceCode = new InheritanceSourceCode("""
                ===================================
                        OOP: Inheritance
                ===================================
                """);
...
{
    public class InheritanceSourceCode
    {
        private string _message { get; set; }
        public InheritanceSourceCode(string message)
        {
            _message = message;
            ...
            ChangeRequest change = new ChangeRequest("Change Base Class Design", "Add members to the class",
                new TimeSpan(4, 0, 0), 1);

            // Use ToString method defined in WorkItem
    ...
    public class WorkItem
    {
        ...
        // instance of WorkItem or ChangeRequest is created, or currentID is referenced.
        static WorkItem() => currentID = 0;

        // currentID is static field. It is incremented each time a new instance of WorkItem is created.
